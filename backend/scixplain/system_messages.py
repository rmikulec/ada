...
4. It will use the specified number of datasources to gather relevant information. These datasources will provide both textual references and image URLs with descriptions.
5. In the generated markdown article, references from datasources will be cited appropriately using a numerical system (e.g., ^[6]) next to the relevant content.
